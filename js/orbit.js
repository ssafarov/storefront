...
(function($) {
  ...
  var ORBIT = {
    ...
    timerRunning: null,
    degrees: 0,
    wrapperHTML: '<div class="orbit-wrapper hidden-xs hidden-sm" />',
    ...
    setupBulletNav: function () {
      ...
      if (this.options.centerBullets) this.$bullets.css('margin-left', -this.$bullets.width() / 2 - 45);
    },
