					...
					<?php if ( is_active_sidebar( 'footer-' . $i ) ) : ?>
						...
						<section class="col-sm-12 col-md-3">
				        	<?php
				                ...
				                if (is_plugin_active( 'social-media-aggregator/im-social-aggregator.php')) {
									if (($widget_columns == 4) && ($i==3)){
										echo do_shortcode('[imsa cols=2 num_items_per_source=2 source_types="facebook, twitter"]');
									};
				                };
					        ?>
						</section>
