...
require get_template_directory() . '/inc/functions/posttypes.php';
require get_template_directory() . '/inc/functions/likes.php';
require get_template_directory() . '/inc/functions/shortcodes.php';
require get_template_directory() . '/inc/functions/views.php';
