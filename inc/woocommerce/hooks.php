 ...
 *
 * removed due to R8 header re-design
 */
 ...
 * @see add_order_actions ()
 * @see add_emails_classes ()
 */
add_filter('woocommerce_resend_order_emails_available', 'add_order_extra_actions');
add_filter('woocommerce_email_classes', 'add_extra_emails_classes');
