						...
						<div class="row">
							<div class="col-sm-12 <?php echo $count == '5' ? '' : 'col-md-6' ?>">
								...
								<?php if  ( get_sub_field( 'button_text' ) ) : ?>
									<br>
									<?php $buttonLink = explode('|', get_sub_field( 'button_text' )); ?>
									<?php if ( count($buttonLink) > 1 ) : ?>
										<a class="btn btn-primary" href="<?php echo $buttonLink[1]; ?>"><?php echo $buttonLink[0]; ?></a><br/><br/>
									<?php else : ?>
										<a class="btn btn-primary" href="#"><?php echo $buttonLink[0]; ?></a><br/><br/>
									<?php endif; ?>
								<?php endif; ?>

								<?php if  ( get_sub_field( 'second_button_text' ) ) : ?>
									<br>
									<?php $buttonLink = explode('|', get_sub_field( 'second_button_text' )); ?>
									<?php if ( count($buttonLink) > 1 ) : ?>
										<a class="btn btn-primary" href="<?php echo $buttonLink[1]; ?>"><?php echo $buttonLink[0]; ?></a><br/><br/>
									<?php else : ?>
										<a class="btn btn-primary" href="#"><?php echo $buttonLink[0]; ?></a><br/><br/>
