...
<?php do_action( 'woocommerce_email_header', $email_heading ); ?>
    ...
    <tr>
        <td>
            <h2 style="font-family: 'Lato', Arial, sans-serif; font-size:24px; line-height: 30px; color: #464646; font-weight:normal;">
                <?php _e('Please don’t forget to download the software to go with your SCANIFY.', 'storefront'); ?>
            </h2>
        </td>
    </tr>
    ...
    <tr>
        <td align="left" class="mobile" style="font-family: 'Lato', Arial, sans-serif; font-size:18px; line-height:24px; font-weight: 300;">
            <?php _e('You are nearly there! Downloading Fuel3D Studio is important if you want to take scans and make them useable.', 'storefront'); ?><br/><br/>
            <?php _e('Remember that you have 5 licenses for Fuel3D Studio with every SCANIFY', 'storefront'); ?>
        </td>
    </tr>
                ...
                <tbody><tr>
                    ...
                    <td width="200" class="mobile" align="center" valign="top">
                        ...
                        <table width="200" cellpadding="0" cellspacing="0" border="0" class="container" align="right">
                            ...
                            <tr>
                                <td align="center">
                                    <img src="<?php echo home_url(); ?>/img/email-templates/image-product-extra-1.jpg" alt="Scanify Bag">
                                </td>
                            </tr>
                            <tr class="mobileOn">
                                <td height="20" style="font-size:10px; line-height:10px;">&nbsp;</td><!-- Spacer -->
