...
?><table id="addresses" cellspacing="0" cellpadding="0" style="width: 100%; vertical-align: top;" border="0">
	...
	<tr>
		...
		<td class="td" style="text-align:left; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" valign="top" width="50%">
			...
			<h3 style="color:#000000;"><?php _e( 'Billing address', 'woocommerce' ); ?></h3>
		...
		<td class="td" style="text-align:left; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" valign="top" width="50%">
			...
			<h3 style="color:#000000;"><?php _e( 'Shipping address', 'woocommerce' ); ?></h3>

			<p class="text" style="color:#000000;"><?php echo $shipping; ?></p>
