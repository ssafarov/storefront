...
<?php foreach ( $get_addresses as $name => $title ) : ?>
    <div class="col-<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> address">
        ...
        <a style="text-decoration:underline; font-weight: bold; color:#9AC31C;" href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="edit"><?php _e( 'Edit Address', 'woocommerce' ); ?></a>
        <?php
...
//terms UK
            ...
            <div style="padding-top:25px;">
                <a style="font-size:12px;" target="_blank" class="finli" href="<?php echo site_url() ?>/right-of-return/">Consumer right of return and refund</a> <br />
                <a style="font-size:12px;" target="_blank" class="finli" href="<?php echo site_url() ?>/cancellation-form">Cancellation form</a><br /><br />
            </div>
