...
if ( $customer_orders ) : ?>
    ...
    global $blog_id;
    if ($blog_id == 1) { ?>
        From the US or Canada? <a style="text-decoration:underline; color:#F00;" href="<?php echo site_url() ?>/usa/my-account/">Click here to view your recent orders</a>
    <?php }
    ?>
    <table class="shop_table my_account_orders" style="margin-top:20px;">
        <thead>
        <tr>
